            ...
            {exportMenuVisible && (
              ...
              >
                <li
                  ...
                  onClick={() => downloadFile(getPlainText(title, intro, body, conclusion), 'blog.txt', 'text/plain')}
                  tabIndex={0}
                >
                  Plain Text
                </li>
                <li
                  className="context-menu-item"
                  onClick={() => downloadFile(getMarkdown(title, intro, body, conclusion), 'blog.md', 'text/markdown')}
                  tabIndex={0}
                >
                  Markdown
                </li>
                <li
                  className="context-menu-item"
                  onClick={() => downloadFile(getHTML(title, intro, body, conclusion), 'blog.html', 'text/html')}
                  tabIndex={0}
                >
                  HTML
                </li>
